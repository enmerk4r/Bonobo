...
namespace Bonobo.Gh
{
    public class TranslateMesh : GH_Component
    {
        /// <summary>
        ...
        public TranslateMesh()
          : base("Translate Mesh", "Translate Mesh",
              "Convert a Rhino Mesh into Blender Mesh object",
        ...
        {
            get { return new Guid("f885c161-563c-4033-a39b-342424e6561b"); }
        }
    }
}
